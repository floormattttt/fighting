...
/** @type {string} */
const CACHE_VERSION = '1777401084|8729815574';
/** @type {string} */
const CACHE_PREFIX = 'Fried Rice-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'testversion3.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["testversion3.html","testversion3.js","testversion3.offline.html","testversion3.icon.png","testversion3.apple-touch-icon.png","testversion3.audio.worklet.js","testversion3.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["testversion3.wasm","testversion3.pck"];
